        ...
        <div className={`fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50`} >
            <div className={`bg-white w-[880px] rounded-lg shadow-lg relative ${styles.modalMain}`}>
                ...
                {isEdit ? <EditInfo setIsEdit={setIsEdit} /> :
                    isRefund ? <RefundAmount setIsRefund={setIsRefund} /> :
                        isViewInfo ? <ViewInfo setIsViewInfo={setIsViewInfo} /> :
                            isPersonalEdit ? <EditPersonalInfo setIsPersonalEdit={setIsPersonalEdit} /> : (
                                <>
