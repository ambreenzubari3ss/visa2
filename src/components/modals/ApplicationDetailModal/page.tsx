...
const ApplicationDetail: React.FC<ModalProps> = ({ isOpen, onClose, data }) => {
    ...
    return (
        <div className={`fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50`} >
            <div className={`bg-white w-[880px] rounded-lg shadow-lg relative ${styles.modalMain}`}>
                {/* Header */}
                {isEdit ? <EditInfo setIsEdit={setIsEdit} onClose={onClose} /> :
                    isRefund ? <RefundAmount setIsRefund={setIsRefund} onClose={onClose} /> :
                        isViewInfo ? <ViewInfo setIsViewInfo={setIsViewInfo} onClose={onClose} /> :
                            isNewApplication ? <NewApplication setIsNewApplication={setIsNewApplication} onClose={onClose} /> :
                                isPersonalEdit ? <EditPersonalInfo setIsPersonalEdit={setIsPersonalEdit} onClose={onClose} /> : (
                                    <>
                                        ...
                                        <div className="grid grid-cols-12 px-6 gap-4">
                                            ...
                                            <div className="col-span-5">
                                                ...
                                                <div className={`${styles.mainDiv}`}>
                                                    <div onClick={() => setIsViewInfo(true)} className="flex items-center justify-between">
                                            ...
                                            <div className="col-span-7">
                                                <div className={`flex flex-col gap-4 ${styles.mainDiv}`}>
                                                    ...
                                                    <button onClick={() => setIsNewApplication(true)} className={styles.infoBtn}>View all Info</button>
                                                </div>
                                        ...
                                        <div className="flex justify-between p-6 pt-0 items-center pt-4">
                                            <div className='flex gap-6'>
                                                ...
                                                <button onClick={() => setIsRefund(true)} className={styles.refundBtn}>
                                                    <TicketSvg />
                                                    <span className="text-[12px] font-[600] underline">Refund Amount</span>
                                                </button>
                                            </div>
                                            <div className="flex gap-2">
                                                <button onClick={() => setIsEdit(true)} className="flex items-center gap-2 bg-[#42DA82] text-white px-6 py-2 rounded-[12px] font-semibold">
                                                    <PencilSvg />
                                                    <span>Apply</span>
                                                </button>
                                            </div>
