...
const TableHeaderPage = ({ header, search }: { header: string, search: boolean }) => {
    return (
        <>
                ...
                <div className="bg-white rounded-xl flex justify-between items-center space-x-2">
                    {search && (
                        <div className="search-container">
                            ...
                            <input type="text" className={`input-search ${styles.inputField}`} placeholder="Search..." />
                        </div>
                    )}

                    <div className="flex space-x-2">
                        <Button className={`flex items-center gap-1 ${styles.filtersBtn}`}>
